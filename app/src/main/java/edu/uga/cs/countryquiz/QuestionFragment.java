...
public class QuestionFragment extends Fragment {
    ...
    public void onViewCreated( View view, Bundle savedInstanceState ) {
        ...
        TextView directions = view.findViewById(R.id.textView9);
        TextView countryText = view.findViewById(R.id.continentQuestionTextView);
        RadioGroup options = view.findViewById(R.id.continentRadioGroup);
        RadioButton optionOne = view.findViewById(R.id.continentOptionA);
        RadioButton optionTwo = view.findViewById(R.id.continentOptionB);
        RadioButton optionThree = view.findViewById(R.id.continentOptionC);
        ...
        optionOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (correctIndex == 0) {
                    QuizQuestions.setScore(position,1);
                } else {
                    QuizQuestions.setScore(position,0);
                }
            }
        });
